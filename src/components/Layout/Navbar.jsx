...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Navbar - Standard Design */}
      <nav className={`lg:hidden fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          ...
          <div className="flex items-center space-x-3">
            <Link
              to="/cart"
              className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 transition-all duration-200 relative"
              title="Cart"
            >
              <ShoppingCart size={20} className="text-gray-600" />
              {cartItemCount > 0 && (
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-30">
          ...
          />
          <div className="absolute top-16 left-4 right-4 bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden max-h-[calc(100vh-8rem)]">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="space-y-1">
                    <Link
                      to="/profile"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-600 hover:text-[#0B7582] hover:bg-gray-100 transition-all duration-200"
                    >
                      <User size={20} />
                ...
                !isOnAuthPage && (
                  <div className="border-t border-gray-200 pt-4 space-y-2">
                    ...
                    <Link
                      to="/register"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="block w-full px-4 py-3 text-center bg-[#0B7582] text-white rounded-lg hover:bg-[#095e68] font-medium transition-colors"
                    >
                      Sign Up
                    </Link>
                  </div>
